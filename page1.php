    ...
    <div class="container">
        ...
        <div class="body-page">
            <div class="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="img/aliceKellenLibro2.png">
                    </div>
                    <input class="carousel-open" type="radio" id="carousel-2" name="carousel" aria-hidden="true" hidden="">
                    <div class="carousel-item">
                        <img src="img/aliceKellenLibro5.jpg">
                    </div>
                    <input class="carousel-open" type="radio" id="carousel-3" name="carousel" aria-hidden="true" hidden="">
                    <div class="carousel-item">
                        <img src="img/aliceKellenLibro7.jpg">
                    </div>
            ...
            <!---------------------------
             ...
             --------------------------->
            <section>
                <h2>Biografia de Alice Kellen</h2>
                <div>
                ...
                <div>
                    <img src="img/aliceKellen1.jpg" width="300" height="300">
                </div>
            </section>
            <section>
                ...
                <div>
                    <div>
                        <img src="img/aliceKellenLibro1.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>Todo lo que nunca fuimos: Deja que ocurra 1</h4>
                        <div>
                    ...
                    <div>
                        <img src="img/aliceKellenLibro4.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>Nosotros en la luna</h4>
                        <div>
                    ...
                    <div>
                        <img src="img/aliceKellenLibro6.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>Todo lo que somos juntos: Deja que ocurra 2</h4>
                        <div>
                    ...
                    <div>
                        <img src="img/aliceKellenLibro8.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>El dia que dejo de nevar en alaska</h4>
                        <div>
                            Un chico con el corazâon de hielo. Una chica que huye de sâi misma. Dos destinos que se cruzan. Heather cree que solo hay tres cosas que sabe hacer:
                            atraer problemas, salir huyendo y correr. Asâi es como termina en Alaska, en un pequeäno pueblo perdido, trabajando de camarera mientras intenta llevar
                            una vida nueva y tranquila. Su âunico problema es que uno de los dueänos del restaurante parece odiarla y que ella nunca antes ha conocido a nadie que
                            despierte tanto su curiosidad. Nilak es reservado, frâio y distante, pero Heather puede ver a travâes de todas las capas tras las que se esconde y sabe que
                            en ocasiones hay recuerdos que pesan demasiado; como los de sus propios errores, esos que intenta dejar atrâas. Pero, a veces, la vida te da una segunda oportunidad.
                            La nieve empieza a derretirse. Y todo encaja.
                        </div>
                    </div>
                    <div>
                        <img src="img/aliceKellenLibro10.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>33 Razones Para Volver a Verte</h4>
                        <div>
                    ...
                    <div>
                        <img src="img/aliceKellenLibro12.jpg" width="300" height="300">
                    </div>
                    <div>
                        <h4>El chico que dibujaba constelaciones</h4>
                        <div>
